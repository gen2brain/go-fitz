...
#cgo linux,!gcc7,amd64 LDFLAGS: -L${SRCDIR}/libs -lmupdf_linux_amd64 -lmupdfthird_linux_amd64 -lm
#cgo linux,gcc7,amd64 LDFLAGS: -L${SRCDIR}/libs -lmupdf_linux_amd64_gcc7 -lmupdfthird_linux_amd64_gcc7 -lm
